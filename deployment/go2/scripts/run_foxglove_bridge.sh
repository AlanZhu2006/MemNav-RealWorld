...
echo "Starting observation + fail-closed operator services Foxglove Bridge"
echo "  websocket: ws://$CFG_FOXGLOVE_ADDRESS:$CFG_FOXGLOVE_PORT"
echo "  layout:    $CFG_FOXGLOVE_LAYOUT"
echo "  control:   operator STOP and camera recovery are callable"
echo "             client publish, navigation start/reset and parameter mutation disabled"
