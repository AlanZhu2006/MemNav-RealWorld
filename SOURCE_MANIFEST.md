...
| `deployment/go2/scripts/run_foxglove_bridge.sh` | Headless observation + stop-only ROS 2 WebSocket bridge and visualization static TF |
...
| `deployment/go2/config/navdp_debug.foxglove-layout.json` | Versioned operator-first camera/depth/goal/arrival/status/trajectory layout with fail-closed STOP |
